...
fasta_file = "./test.cds.fasta"
ortho_file = "./test.orthogroups_for_CDS_.fix.tsv"
...
with open(ortho_file, "r") as input_file, open("./test.orthogroups_with_lengths.tsv", "w") as output_file:
